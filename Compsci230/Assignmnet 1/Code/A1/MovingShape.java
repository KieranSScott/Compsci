...
public abstract class MovingShape {
     ...
     */
    public MovingShape() {
        this(10, 20, 800, 500, Color.black, Color.blue, 0, 50, 20); // the default properties
    }
     ...
     */
    public MovingShape(int x, int y, int mw, int mh, Color c, Color fc, int pathType, int width, int height) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
